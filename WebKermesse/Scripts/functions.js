...
initialize = function(){
  var latLng = new google.maps.LatLng(48.083328, -1.6742900); // Correspond au coordonnées de Rennes
  var myOptions = {
  ...
  var contentMarker = [
      ...
      '</ul>',
      '<div id="tab-1">',
        '<h3>Rennes</h3><p>Suspendisse quis magna dapibus orci porta varius sed sit amet purus. Ut eu justo dictum elit malesuada facilisis. Proin ipsum ligula, feugiat sed faucibus a, <a href="http://www.google.fr">google</a> sit amet mauris. In sit amet nisi mauris. Aliquam vestibulum quam et ligula pretium suscipit ullamcorper metus accumsan.</p>',
      '</div>',
      '<div id="tab-2">',
